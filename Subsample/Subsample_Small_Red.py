"""
MAKE FITS FILE FOR THE SMALL RED SUBSAMPLE
"""
import numpy as np
...
OutputFilename = "redmapper_dr8_public_v5.10_catalog.value_added.Z_LAMBDA_0.1_0.33.LAMBDA_lt100-2" + ".subsample_R_S" ".fits"
